...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Quản lý sân bóng</h1>
                        </div><!-- /.col -->
            ...
            <div class="d-flex justify-content-end">
                <?php
                if ($role == "Admin") {
                    echo '<a href="themsan.php" class="btn btn-info">Thêm sân</a>';
                }
                ?>
            </div>
            ...
            <table class="table text-center">
                ...
                <tbody>
                    <tr class="table-active">
                        ...
                        <td scope="col"><?php echo $row1['TenSan'] ?></td>
                        <td scope="col"><?php echo $row1['ChiNhanh'] ?></td>
                        <td scope="col"><?php echo $row1['GiaThue'] ?></td>
                        <td scope="col"><?php echo $row1['DiaChi'] ?></td>
                        <td scope="col"><?php echo $row1['MoTa'] ?></td>
                        <td scope="col"><?php echo $row1['AnhSan'] ?></td>

                        <?php
                            if ($role == "Admin") {
                                echo '<td scope="col"><a href="themsan.php?MaSan=' . $row1['MaSan'] . '">Sửa</a>|| <a onclick="
                                return checkOk()" href="delete_san.php?iddeleteSan='.$row1['MaSan'].'">Xóa</a></td>';
                            }
                            ?>
                    </tr>
                </tbody>
    ...
    <script>
    function checkOk() {
        var result = confirm("Xác nhận xóa sân bóng");
        if (result) {
            return true;
        } else {
            return false;
